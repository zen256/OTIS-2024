...
def delete_vertex_handler():
    main_label.configure(text="Click on the vertex or edge to delete")
    canvas.unbind(text_of_button_first)
...
def rename_vertex_handler():
    main_label.configure(text="Click on the vertex to rename it")
    canvas.unbind(text_of_button_first)
...
def change_color_handler():
    main_label.configure(text="Click on the vertex to change its color")
    canvas.unbind(text_of_button_first)
...
def change_text_color_handler():
    main_label.configure(text="Click on the vertex to change the color of its text")
    canvas.unbind(text_of_button_first)
...
def change_edge_color_handler():
    main_label.configure(text="Click on the edge to change its color")
    canvas.unbind(text_of_button_first)
...
graph_menu.add_command(label="Draw a vertex", command=draw_vertex_handler)
graph_menu.add_command(label="Draw an edge", command=draw_edge_handler)
graph_menu.add_command(label="Removing vertices or edges", command=delete_vertex_handler)
...
algorithms = tk.Menu(menubar, tearoff=0)
menubar.add_cascade(label="Algorithms", menu=algorithms)
algorithms.add_command(label="Output the adjacency matrix", command=adjacency_matrix_handler)
algorithms.add_command(label="Output the incidence matrix", command=incidence_matrix_handler)
algorithms.add_command(label="Search in depth", command=dfs_handler)
algorithms.add_command(label="Search in width", command=bfs_handler)
